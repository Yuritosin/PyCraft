...
from mesh.chunk_mesh_builder import get_chunk_index
...
class VoxelHandler:
    ...
    def add_voxel(self):
        if self.voxel_id:
            ...
            # TODO FUCKING SHIT
            # print(self.voxel_world_pos)
            if self.voxel_world_pos[1] >= WORLD_H * CHUNK_SIZE:
                return
    ...
    def ray_cast(self):
        ...
        x2, y2, z2 = self.engine.player.position + self.engine.player.forward * RAYCASTING_MAX_LENGTH
